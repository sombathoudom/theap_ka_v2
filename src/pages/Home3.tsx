        ...
        {!openInvitation ? (
          <>
            ...
            <video
              ...
              playsInline
              preload="auto"
              src={window.innerWidth <= 430 ? "/video_three.mp4" : "/video_first.mp4"}
              className={`w-full h-full object-cover absolute inset-0 z-10 transition-opacity duration-200 ${showSecondVideo ? 'opacity-100' : 'opacity-0'}`}
            >
              <source src={window.innerWidth <= 430 ? "/video_three.mp4" : "/video_first.mp4"} type="video/mp4" />
            </video>
            <div className={`absolute bottom-24 left-1/2 -translate-x-1/2 flex flex-col items-center gap-6 w-full max-w-sm z-20 transition-opacity duration-500 ${isTransitioning ? 'opacity-0' : 'opacity-100'}`}>
          ...
          <>
            <video
              key={"/page_3_video.mp4"}
              autoPlay
              loop
              muted
              playsInline
              preload="auto"
              src={"/page_3_video.mp4"}
            ...
            <div className="relative w-full h-full overflow-y-auto">
              <div className="min-h-screen flex items-center justify-center pt-28">
                <img src="/paper_1.png" alt="" className="w-full max-w-2xl h-auto object-contain"/>
              </div>
